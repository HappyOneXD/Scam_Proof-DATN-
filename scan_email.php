...
<body class="bg-black text-white">
    ...
    <section class="hero-video position-relative w-100 bg-dark" style="height: 40vh; overflow: hidden;">
        ...
        <div class="hero-overlay-text d-flex flex-column justify-content-center align-items-center text-center">
            <h1 class="boiler-title">Email Scan</h1>
            <h2 class="boiler-subtitle font-monospace">Analyse suspicious emails for phishing signs.</h2>
        </div>
    </section>
                        ...
                        <form method="post" action="scan.php">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="emailContentInput"
                                          name="email_content" rows="6"
                                          placeholder="Paste the full email body here" required></textarea>
                            </div>
                            <button type="submit" class="btn btn-light w-100">Scan Email</button>
                        </form>
                    </div>
                </div>
            </div>
